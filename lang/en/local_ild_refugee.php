...
$string['pluginname'] = 'Confirm refugee status';
$string['confirmcheckfull'] = 'Do you really want to confirm {$a}?';
$string['rejectcheckfull'] = 'Do you really want to reject {$a}?';
$string['email_subject'] = 'Refugee status confirmed';
$string['thankyou'] = 'Upload successfull';
